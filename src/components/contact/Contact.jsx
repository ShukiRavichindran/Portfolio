...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm('service_9ftmome', 'template_byw4epv', form.current, {
        publicKey: '3Pfe9ZyyBpXq5NsbQ',
      })
      e.target.reset();
  };
    return (
            ...
            <div className="contact__container container grid">
                <div className="contact__content">
                    ...
                    <div className="contact__info">
                        ...
                        <span className="contact__card-data">shukiravi03@gmail.com</span>

                        <a href="mailto:shukiravi03@gmail.com.com" className="contact__button">Write me {" "}
                        ...
                        <span className="contact__card-data">99429 48181</span>

                        <a href="https://api.whatsapp.com/send? phone=9443946275&text=Hello, more info" className="contact__button">Write me {" "}
                        <i className="bx bx-right-arrow-alt contact__button-icon">
                            </i></a>
                        </div>
                ...
                <div className="contact__content">
                    ...
                    <form ref={form} onSubmit={sendEmail} >
                        ...
                        <div className="contact__form-div contact__form-area">
                            ...
                            <textarea name="project" cols='30' rows='10' className='contact__form-input' placeholder='Enter you project details'></textarea>
                        </div>
